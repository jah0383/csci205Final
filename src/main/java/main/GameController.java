...
public class GameController {
    ...
    private void setupUpgrades() {
        ...
        for (int i = 1; i < this.theModel.getUpgrades().size(); i++) {
            ...
            gainUp1.setText(String.format("%s Gain 2x",producerNames.get(i - 1)));
            ...
            gainUp2.setText(String.format("%s Gain 8x",producerNames.get(i - 1)));
            ...
            periodUp1.setText(String.format("%s Time .5x",producerNames.get(i - 1)));
            ...
            periodUp2.setText(String.format("%s Time .25x",producerNames.get(i - 1)));
